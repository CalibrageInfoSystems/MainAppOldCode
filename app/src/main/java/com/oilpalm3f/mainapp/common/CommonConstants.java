...
import com.oilpalm3f.mainapp.datasync.refreshsyncmodel.UserData;
...
public class CommonConstants {
    ...
    public static String DATE_FORMAT_DDMMYYYY_HHMMSS_SSS_NEW ="yyyy-MM-ddTHH:mm:ss.SSS";
...
//    public static int CanalOthersID = 131;
    ...
    public static String ISReoveryFarmersubmitted = null;

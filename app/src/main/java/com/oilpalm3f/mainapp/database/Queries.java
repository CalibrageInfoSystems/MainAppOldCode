...
//    public  String getActiveFarners(){
//        return  "SELECT Id,Code, Name, MobileNumber, Village,Mandal from Harvestor where IsActive = 'true'";
//    }
...
//                "   where  c.IsMill = 'false' AND c.VillageId IN (select villageId from UserVillageXref where userId IN ('"+userid+"')) and c.IsActive = 'true' ORDER BY c.Name Asc";
    ...
    public String getMaxNumberQueryForHarvesting() {
        ...
        //return "select max(substr(Code, instr(Code, '-')+1)+1) as Maxnumber FROM HarvestorVisitHistory";
...
//    public String checkRecordStatusInRecoveryFarmerTable(String tableName, int id, String columnName, String columnValue,String RecoveryFarmerCode) {
//        return "SELECT EXISTS(SELECT 1 FROM " + tableName + " where Id = '" + columnValue + "' and " + columnName + "= '" + columnValue + "' and RecoveryFarmerCode = '"+ RecoveryFarmerCode + "')";
//    }
...
//    public String checkRecordStatusInRecoveryFarmerTable(String tableName, String columnName, String columnValue,String RecoveryFarmerCode) {
//        return "SELECT EXISTS(SELECT 1 FROM " + tableName + " where " + columnName + "= '" + columnValue + "' and RecoveryFarmerCode = '"+ RecoveryFarmerCode + "')";
//    }

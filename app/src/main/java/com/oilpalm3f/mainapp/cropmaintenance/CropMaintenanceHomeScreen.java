...
public class CropMaintenanceHomeScreen extends OilPalmBaseActivity implements TypeChooserDialog.typeChooser, UpdateUiListener, WaterSoilTypeDialogFragment.onTypeSelected {
    ...
    private String cnt2018="0";
    private String cnt2019="0";
...
//                replaceFragment(mComplaintDetailsFragment);
            ...
            case R.id.yieldBtn:
                ...
                case R.id.finishBtn:
                     ...
                     cnt2018 = dataAccessHandler.getOnlyOneValueFromDb(Queries.getInstance().get2018WhiteCount());
                     cnt2019 = dataAccessHandler.getOnlyOneValueFromDb(Queries.getInstance().get2019WhiteCount());
                ...
                if (DisplayPlotsFragment.plotCode.equalsIgnoreCase(enteredPlot.getCode())){
                    ...
                    } else if(!is2018WhiteFly() && CommonConstants.CURRENT_TREE>0){
                        UiUtils.showCustomToastMessage("Please enter Whitefly Data for 2019-2020 Year", CropMaintenanceHomeScreen.this, 0);
                    }
                    else if(!is2019WhiteFly() && CommonConstants.CURRENT_TREE>0){
                        UiUtils.showCustomToastMessage("Please enter Whitefly Data for 2020-2021 Year", CropMaintenanceHomeScreen.this, 0);
                    }
                    else if(!isWhiteFly() && CommonConstants.CURRENT_TREE>0){
                        UiUtils.showCustomToastMessage("Please enter Whitefly Data", CropMaintenanceHomeScreen.this, 0);
    ...
    private boolean is2018WhiteFly() {
            boolean s=true;
        if (cnt2018.length() > 0){
...
//                if ( whiteFlyList.size()>0  ) {
    ...
    private boolean is2019WhiteFly() {
        boolean s=true;
        if (cnt2018.length() > 0){

...
public class CropMaintanenceIdProofsDetails extends Fragment {
    ...
    private void initViews() {
        ...
        mIdentityProofList = (ArrayList<IdentityProof>) dataAccessHandler.getSelectedIdProofsData(Queries.getInstance().getSingleFarmerIdentityProof(CommonConstants.FARMER_CODE), 1);

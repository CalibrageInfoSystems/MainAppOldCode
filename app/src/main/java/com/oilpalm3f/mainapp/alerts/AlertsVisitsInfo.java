...
public class AlertsVisitsInfo {
    ...
    private String plotvisiteddate;
    ...
    public String getPlotvisiteddate() {
        return plotvisiteddate;
    }

    public void setPlotvisiteddate(String plotvisiteddate) {
        this.plotvisiteddate = plotvisiteddate;
    }
}
